...
import org.semux.sdk.crypto.bip32.util.BytesUtil;
import org.semux.sdk.crypto.bip32.util.HashUtil;
import org.semux.sdk.crypto.bip32.util.Hmac;
import org.semux.sdk.crypto.bip32.util.Secp256k1;
...
public class HdKeyGenerator {
     ...
     * @param isHardened whether the child index is hardened
     * @param scheme     the curve
     * @return
     */
